export default function UserPage({ params }: { params: { id: string } }) {
  ...
  const userData = {
    '1': { name: 'Alice Johnson', role: 'user', email: 'alice@example.com', joined: '2023-01-15' },
    '2': { name: 'Bob Smith', role: 'admin', email: 'bob@example.com', joined: '2022-08-20' },
    '3': { name: 'Carol Davis', role: 'moderator', email: 'carol@example.com', joined: '2023-03-10' }
  };
  ...
  if (!user) {
    return (
      <div>
        <h1>User Not Found (App Router)</h1>
      ...
      <div style={{ backgroundColor: '#f8f9fa', padding: '20px', borderRadius: '8px', marginTop: '20px' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '20px' }}>
          ...
          <div>
            ...
            <p style={{ margin: '0', color: '#6c757d' }}>ID: {params.id}</p>
            <span style={{
